...
BOT_TOKEN = environ.get('BOT_TOKEN', '5717806604:AAFE6aBBpUt3hyTHk_72yqKh7aiWm_eNpJE') #BOT TOKEN
...
MESSAGE_ID = int(environ.get('MESSAGE_ID', 17)) #SUB CHANNEL STATUS ID
